...
def get_annpaths(ann_dir_path: str = None,
    ...
    ann_paths = glob.glob(os.path.join(ann_dir_path, "*.xml"))
    return ann_paths
...
def main():
    ...
    parser.add_argument('--ann_dir', type=str, default=None,
                        help='path to annotation files directory. script will search for *.xml files inside it. It is not need when use --ann_paths_list')
